...
public class ProductorProducto {
    ...
    public ProductorProducto(int precio, int stock, String calibre_idcalibre, String producto_idproducto, int productor_rut, String img) {
        this.precio = precio;
        this.stock = stock;
    ...
    public String toString() {
        return "ProductorProducto{" + "precio=" + precio + ", stock=" + stock + ", calibre_idcalibre=" + calibre_idcalibre + ", producto_idproducto=" + producto_idproducto + ", productor_rut=" + productor_rut + ", img=" + img + '}';
    }
